...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE_2_2/ORCHIDEE/src_sechiba/diffuco.f90 $
...
!_ ================================================================================================================================
  ...
  SUBROUTINE diffuco_main (kjit, kjpindex, index, indexveg, indexlai, u, v, &
     ...
     & evap_bare_lim, evap_bare_lim_ns, evapot, evapot_corr, snow, flood_frac, flood_res, frac_nobio, snow_nobio, totfrac_nobio, &
...
!_ ================================================================================================================================
  ...
  !! 5. Calculate the beta coefficient for transpiration
   ...
   !! New resistance calc. with temporary (dummy) variables, just for vbeta3pot
    ...
    CALL diffuco_bare (kjpindex, tot_bare_soil, veget_max, evap_bare_lim, evap_bare_lim_ns, vbeta2, vbeta3, vbeta4)
  ...
  !! 6. Combine the alpha and beta coefficients
    ...
    CALL diffuco_comb (kjpindex, humrel, rau, u, v, q_cdrag, pb, qair, temp_sol, temp_air, snow, &
       & veget, lai, tot_bare_soil, vbeta1, vbeta2, vbeta3, vbeta4, &
       & evap_bare_lim, evap_bare_lim_ns, veget_max, vbeta, qsintmax)
...
!_ ================================================================================================================================
  ...
  SUBROUTINE diffuco_bare (kjpindex, tot_bare_soil, veget_max, evap_bare_lim, evap_bare_lim_ns, vbeta2, vbeta3, vbeta4)
...
SUBROUTINE diffuco_trans_co2 (kjpindex, swdown, pb, qsurf, qair, temp_air, temp_growth, rau, u, v, q_cdrag, humrel, &
                                assim_param, Ca, &
...
! @endcodeinc
    ...
    IF (downregulation_co2_new) THEN
       ...
       ! parametrization allows a behavior in the same way as for the preindustral period.
       DO jv= 1, nvm
...
! @}
    ...
    DO jv = 2,nvm
      ...
      gb_h2o(:) = gb_ref * 44.6 * (tp_00/temp_air(:)) * (pb(:)/pb_std) 
                  ...
                  DO limit_photo=1,2
                     ...
                     IF ( ( A_3 .EQ. 9999. ) .OR. ( A_3 .LT. (-Rd(icinic,jl)) ) ) THEN
                        IF ( printlev>=4 ) THEN
                           ...
                           WRITE(numout,*) 'temp_air:',temp_air(icinic)
...
!_ ================================================================================================================================
  ...
  SUBROUTINE diffuco_comb (kjpindex, humrel, rau, u, v, q_cdrag, pb, qair, temp_sol, temp_air, &
       & snow, veget, lai, tot_bare_soil, vbeta1, vbeta2, vbeta3 , vbeta4, &
       & evap_bare_lim, evap_bare_lim_ns, veget_max, vbeta, qsintmax)    
