...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE_2_2/ORCHIDEE/src_parameters/vertical_soil.f90 $
!! $Date: 2018-10-03 10:22:28 +0200 (Wed, 03 Oct 2018) $
!! $Revision: 5454 $
!! \n
!_ ================================================================================================================================
MODULE vertical_soil
...
!_ ================================================================================================================================
  ...
  SUBROUTINE vertical_soil_init
    ...
    REAL(r_std), DIMENSION(nblayermax)   :: zint              !! Depth at the interface of each layer (m)
    ...
    !Config If    = 
    !Config Def   = .FALSE.
    !Config Help  =  Refinebottom is important when lower boundary conditions is different from a free drainage.
    !Config Units = -
    refinebottom = .FALSE.
    ...
    ! unwinde it for temperature below zmaxh. Only done for option refinebottom.   
    IF ( nbrefine > 1 ) THEN
       DO i=ntmp,ntmp+nbrefine-1
          iref=nbrefine-(i-ntmp)
