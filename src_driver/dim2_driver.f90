...
!!   
!! SVN     :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE_2_2/ORCHIDEE/src_driver/dim2_driver.f90 $ 
!! $Date: 2022-02-16 11:24:32 +0100 (Wed, 16 Feb 2022) $
!! $Revision: 7475 $
!! \n
!_ ================================================================================================================================
...
PROGRAM driver
  ...
  REAL :: date_cur  ! Starting date of the current execution
  REAL :: zlflu
  REAL :: alpha
...
!-
! Transform time lenght into number of time step (itau_len) using date of current year
!-
