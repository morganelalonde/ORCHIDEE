...
!!   
!! SVN     :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE_2_2/ORCHIDEE/src_driver/readdim2.f90 $ 
!! $Date: 2022-09-16 14:01:29 +0200 (Fri, 16 Sep 2022) $
!! $Revision: 7751 $
!! \n
!_ ================================================================================================================================
...
!! 0.3 Local variables
    ...
    IF ( interpol ) THEN
       ...
       IF (is_root_prc) THEN
          ...
          ALLOCATE(fcontfrac(iim_zoom,jjm_zoom))
  ...
  IMPLICIT NONE
   ...
   ELSEIF ( weathergen ) THEN
      ...
      IF ( (itauin == 0).AND.(itau_split == 0) ) THEN
         ...
         !--- Allocate grid stuff
         !---
         CALL grid_init ( nbindex, 4, regular_lonlat, "ForcingGrid" )
         !---
         !--- Compute
         !---
