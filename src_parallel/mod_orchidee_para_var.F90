...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE_2_2/ORCHIDEE/src_parallel/mod_orchidee_para_var.F90 $
!! $Date: 2019-11-04 10:22:17 +0100 (Mon, 04 Nov 2019) $
!! $Revision: 6289 $
!! \n
!_ ================================================================================================================================
...
MODULE mod_orchidee_para_var
  ...
  LOGICAL,SAVE :: is_omp_root                  !! Only OpenMP master thread is true
  ...
  INTEGER(i_std),SAVE,DIMENSION(:),ALLOCATABLE :: ij_omp_para_nb
  INTEGER(i_std),SAVE,DIMENSION(:),ALLOCATABLE :: ij_omp_para_begin
  INTEGER(i_std),SAVE,DIMENSION(:),ALLOCATABLE :: ij_omp_para_end    
  ...
  INTEGER(i_std),SAVE :: ij_omp_nb
  INTEGER(i_std),SAVE :: ij_omp_begin
  INTEGER(i_std),SAVE :: ij_omp_end
  !$OMP  THREADPRIVATE(nbp_omp,nbp_omp_begin,nbp_omp_end,offset_omp)
  !$OMP  THREADPRIVATE(ij_omp_nb,ij_omp_begin,ij_omp_end)
  ...
  !
  REAL(r_std), ALLOCATABLE, DIMENSION(:,:), SAVE      :: seglength_g
  !
  ...
  REAL(r_std), ALLOCATABLE, DIMENSION(:,:), SAVE     :: lon_g, lat_g
  !-
