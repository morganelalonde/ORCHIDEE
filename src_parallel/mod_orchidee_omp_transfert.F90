...
!!
!! SVN              :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE_2_2/ORCHIDEE/src_parallel/mod_orchidee_omp_transfert.F90 $
...
MODULE mod_orchidee_omp_transfert
  ...
  INTERFACE scatter_unindexed_omp
     MODULE PROCEDURE scatter_unindexed_omp_i,scatter_unindexed_omp_i1,scatter_unindexed_omp_i2,scatter_unindexed_omp_i3, &
          scatter_unindexed_omp_r,scatter_unindexed_omp_r1,scatter_unindexed_omp_r2,scatter_unindexed_omp_r3, &
          scatter_unindexed_omp_l,scatter_unindexed_omp_l1,scatter_unindexed_omp_l2,scatter_unindexed_omp_l3
  END INTERFACE


  INTERFACE gather_unindexed_omp
     MODULE PROCEDURE gather_unindexed_omp_i,gather_unindexed_omp_i1,gather_unindexed_omp_i2,gather_unindexed_omp_i3, &
          gather_unindexed_omp_r,gather_unindexed_omp_r1,gather_unindexed_omp_r2,gather_unindexed_omp_r3, &
          gather_unindexed_omp_l,gather_unindexed_omp_l1,gather_unindexed_omp_l2,gather_unindexed_omp_l3  
  END INTERFACE
  ...
  PUBLIC  bcast_omp,scatter_omp,gather_omp,reduce_sum_omp, scatter_unindexed_omp, gather_unindexed_omp
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  SUBROUTINE scatter_unindexed_omp_i(VarIn, VarOut)
...
#else
    CALL check_buffer_i(size(VarIn))   
    CALL orch_scatter_unindexed_omp_igen(VarIn,Varout,1,omp_ibuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_i

  SUBROUTINE scatter_unindexed_omp_i1(VarIn, VarOut)
...
#else
    CALL check_buffer_i(size(VarIn))   
    CALL orch_scatter_unindexed_omp_igen(VarIn,Varout,SIZE(VarOut,2),omp_ibuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_i1

  SUBROUTINE scatter_unindexed_omp_i2(VarIn, VarOut)
...
#else    
    CALL check_buffer_i(size(VarIn))   
    CALL orch_scatter_unindexed_omp_igen(VarIn,Varout,SIZE(VarOut,2)*SIZE(VarOut,3),omp_ibuffer)
#endif
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_i2

  SUBROUTINE scatter_unindexed_omp_i3(VarIn, VarOut)
...
#else    
    CALL check_buffer_i(size(VarIn))   
    CALL orch_scatter_unindexed_omp_igen(VarIn,Varout,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4),omp_ibuffer)
#endif  
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_i3


  SUBROUTINE scatter_unindexed_omp_r(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarIn))   
    CALL orch_scatter_unindexed_omp_rgen(VarIn,Varout,1,omp_rbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_r

  SUBROUTINE scatter_unindexed_omp_r1(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarIn))   
    CALL orch_scatter_unindexed_omp_rgen(VarIn,Varout,SIZE(VarOut,2),omp_rbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_r1

  SUBROUTINE scatter_unindexed_omp_r2(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarIn))   
    CALL orch_scatter_unindexed_omp_rgen(VarIn,Varout,SIZE(VarOut,2)*SIZE(VarOut,3),omp_rbuffer)
#endif
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_r2

  SUBROUTINE scatter_unindexed_omp_r3(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarIn))   
    CALL orch_scatter_unindexed_omp_rgen(VarIn,Varout,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4),omp_rbuffer)
#endif  
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_r3


  SUBROUTINE scatter_unindexed_omp_l(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarIn))   
    CALL orch_scatter_unindexed_omp_lgen(VarIn,Varout,1,omp_lbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_l

  SUBROUTINE scatter_unindexed_omp_l1(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarIn))   
    CALL orch_scatter_unindexed_omp_lgen(VarIn,Varout,SIZE(VarOut,2),omp_lbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_l1

  SUBROUTINE scatter_unindexed_omp_l2(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarIn))   
    CALL orch_scatter_unindexed_omp_lgen(VarIn,Varout,SIZE(VarOut,2)*SIZE(VarOut,3),omp_lbuffer)
#endif
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_l2

  SUBROUTINE scatter_unindexed_omp_l3(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarIn))   
    CALL orch_scatter_unindexed_omp_lgen(VarIn,Varout,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4),omp_lbuffer)
#endif  
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE scatter_unindexed_omp_l3
...
!!!!! --> Les entiers
  ...
  SUBROUTINE gather_unindexed_omp_i(VarIn, VarOut)
...
#else
    CALL check_buffer_i(size(VarOut))   
    CALL orch_gather_unindexed_omp_igen(VarIn,Varout,1,omp_ibuffer)
#endif
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_i


  SUBROUTINE gather_unindexed_omp_i1(VarIn, VarOut)
...
#else
    CALL check_buffer_i(size(VarOut))   
    CALL orch_gather_unindexed_omp_igen(VarIn,Varout,SIZE(VarIn,2),omp_ibuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_i1


  SUBROUTINE gather_unindexed_omp_i2(VarIn, VarOut)
...
#else
    CALL check_buffer_i(size(VarOut))   
    CALL orch_gather_unindexed_omp_igen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3),omp_ibuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_i2


  SUBROUTINE gather_unindexed_omp_i3(VarIn, VarOut)
...
#else
    CALL check_buffer_i(size(VarOut))   
    CALL orch_gather_unindexed_omp_igen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4),omp_ibuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_i3

!!!!! --> Les reels


  SUBROUTINE gather_unindexed_omp_r(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarOut))   
    CALL orch_gather_unindexed_omp_rgen(VarIn,Varout,1,omp_rbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_r


  SUBROUTINE gather_unindexed_omp_r1(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarOut))   
    CALL orch_gather_unindexed_omp_rgen(VarIn,Varout,SIZE(VarIn,2),omp_rbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_r1


  SUBROUTINE gather_unindexed_omp_r2(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarOut))   
    CALL orch_gather_unindexed_omp_rgen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3),omp_rbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_r2


  SUBROUTINE gather_unindexed_omp_r3(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarOut))   
    CALL orch_gather_unindexed_omp_rgen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4),omp_rbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_r3

!!!!! --> Les booleen


  SUBROUTINE gather_unindexed_omp_l(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarOut))   
    CALL orch_gather_unindexed_omp_lgen(VarIn,Varout,1,omp_lbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_l


  SUBROUTINE gather_unindexed_omp_l1(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarOut))   
    CALL orch_gather_unindexed_omp_lgen(VarIn,Varout,SIZE(VarIn,2),omp_lbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_l1


  SUBROUTINE gather_unindexed_omp_l2(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarOut))   
    CALL orch_gather_unindexed_omp_lgen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3),omp_lbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_l2


  SUBROUTINE gather_unindexed_omp_l3(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarOut))   
    CALL orch_gather_unindexed_omp_lgen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4),omp_lbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_unindexed_omp_l3
...
SUBROUTINE orch_scatter_unindexed_omp_igen(VarIn,VarOut,dimsize,Buff)
  USE mod_orchidee_omp_data
  USE mod_orchidee_para_var, ONLY : ij_nb 
  IMPLICIT NONE

  INTEGER,INTENT(IN) :: dimsize
  INTEGER,INTENT(IN),DIMENSION(ij_nb,dimsize) :: VarIn
  INTEGER,INTENT(OUT),DIMENSION(ij_omp_nb,dimsize) :: VarOut
  INTEGER,INTENT(INOUT),DIMENSION(ij_nb,dimsize) :: Buff
  ...
  DO i=1,dimsize
     DO ij=1,ij_omp_nb
        VarOut(ij,i)=Buff(ij_omp_begin-1+ij,i)
     ENDDO
  ENDDO
  ...
  IF ( check_all_transfert ) &
      omp_function(omp_rank)=omp_previous
END SUBROUTINE orch_scatter_unindexed_omp_igen


SUBROUTINE orch_scatter_unindexed_omp_rgen(VarIn,VarOut,dimsize,Buff)
  USE mod_orchidee_omp_data
  ...
  INTEGER,INTENT(IN) :: dimsize
  REAL,INTENT(IN),DIMENSION(ij_nb,dimsize) :: VarIn
  REAL,INTENT(OUT),DIMENSION(ij_omp_nb,dimsize) :: VarOut
  REAL,INTENT(INOUT),DIMENSION(ij_nb,dimsize) :: Buff
  ...
  IF ( check_all_transfert ) &
      omp_function(omp_rank)=omp_previous
END SUBROUTINE orch_scatter_unindexed_omp_rgen


SUBROUTINE orch_scatter_unindexed_omp_lgen(VarIn,VarOut,dimsize,Buff)
  USE mod_orchidee_omp_data
  ...
  LOGICAL,INTENT(OUT),DIMENSION(ij_omp_nb,dimsize) :: VarOut
  LOGICAL,INTENT(INOUT),DIMENSION(ij_nb,dimsize) :: Buff
  ...
  IF ( check_all_transfert ) &
      omp_function(omp_rank)=omp_previous
END SUBROUTINE orch_scatter_unindexed_omp_lgen




SUBROUTINE orch_gather_unindexed_omp_igen(VarIn,VarOut,dimsize,Buff)
  USE mod_orchidee_omp_data
  ...
  INTEGER,INTENT(IN) :: dimsize
  INTEGER,INTENT(IN),DIMENSION(ij_omp_nb,dimsize) :: VarIn
  INTEGER,INTENT(OUT),DIMENSION(ij_nb,dimsize) :: VarOut
  INTEGER,INTENT(INOUT),DIMENSION(ij_nb,dimsize) :: Buff
  ...
  DO i=1,dimsize
     DO ij=1,ij_omp_nb
        Buff(ij_omp_begin-1+ij,i)=VarIn(ij,i)
     ENDDO
  ENDDO
  ...
  IF ( check_all_transfert ) &
      omp_function(omp_rank)=omp_previous
END SUBROUTINE orch_gather_unindexed_omp_igen





SUBROUTINE orch_gather_unindexed_omp_rgen(VarIn,VarOut,dimsize,Buff)
  USE mod_orchidee_omp_data
  ...
  INTEGER,INTENT(IN) :: dimsize
  REAL,INTENT(IN),DIMENSION(ij_omp_nb,dimsize) :: VarIn
  REAL,INTENT(OUT),DIMENSION(ij_nb,dimsize) :: VarOut
  REAL,INTENT(INOUT),DIMENSION(ij_nb,dimsize) :: Buff
  ...
  IF ( check_all_transfert ) &
      omp_function(omp_rank)=omp_previous
END SUBROUTINE orch_gather_unindexed_omp_rgen



SUBROUTINE orch_gather_unindexed_omp_lgen(VarIn,VarOut,dimsize,Buff)
  USE mod_orchidee_omp_data
  ...
  INTEGER,INTENT(IN) :: dimsize
  LOGICAL,INTENT(IN),DIMENSION(ij_omp_nb,dimsize) :: VarIn
  ...
  IF ( check_all_transfert ) &
      omp_function(omp_rank)=omp_previous
END SUBROUTINE orch_gather_unindexed_omp_lgen
