...
!!
!! SVN              :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE_2_2/ORCHIDEE/src_parallel/mod_orchidee_mpi_transfert.F90 $
...
#include "src_parallel.h"
  ...
  INTERFACE scatter_unindexed_mpi
     MODULE PROCEDURE scatter_unindexed_mpi_i,scatter_unindexed_mpi_i1,scatter_unindexed_mpi_i2,scatter_unindexed_mpi_i3, &
          scatter_unindexed_mpi_r,scatter_unindexed_mpi_r1,scatter_unindexed_mpi_r2,scatter_unindexed_mpi_r3, &
          scatter_unindexed_mpi_l,scatter_unindexed_mpi_l1,scatter_unindexed_mpi_l2,scatter_unindexed_mpi_l3
  END INTERFACE

  INTERFACE gather_unindexed_mpi
     MODULE PROCEDURE gather_unindexed_mpi_i,gather_unindexed_mpi_i1,gather_unindexed_mpi_i2,gather_unindexed_mpi_i3, &
          gather_unindexed_mpi_r,gather_unindexed_mpi_r1,gather_unindexed_mpi_r2,gather_unindexed_mpi_r3, &
          gather_unindexed_mpi_l,gather_unindexed_mpi_l1,gather_unindexed_mpi_l2,gather_unindexed_mpi_l3  
  END INTERFACE
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!! Definition des Scatter_unindexed   --> 4D   !!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!




  SUBROUTINE scatter_unindexed_mpi_i(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_igen(VarIn,Varout,SIZE(VarIn,1),1)
    ELSE
       CALL orch_scatter_unindexed_mpi_igen(dummy,Varout,1,1)
    ENDIF

#endif
  END SUBROUTINE scatter_unindexed_mpi_i

  SUBROUTINE scatter_unindexed_mpi_i1(VarIn, VarOut)
...
#else
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_igen(VarIn,Varout,SIZE(VarIn,1),SIZE(VarOut,2))
    ELSE
       CALL orch_scatter_unindexed_mpi_igen(dummy,Varout,1,SIZE(VarOut,2))
    ENDIF

#endif
  END SUBROUTINE scatter_unindexed_mpi_i1

  SUBROUTINE scatter_unindexed_mpi_i2(VarIn, VarOut)
...
#else    
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_igen(VarIn,Varout,SIZE(VarIn,1),SIZE(VarOut,2)*SIZE(VarOut,3))
    ELSE
       CALL orch_scatter_unindexed_mpi_igen(dummy,Varout,1,SIZE(VarOut,2)*SIZE(VarOut,3))
    ENDIF
#endif
  END SUBROUTINE scatter_unindexed_mpi_i2

  SUBROUTINE scatter_unindexed_mpi_i3(VarIn, VarOut)
...
#else    
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_igen(VarIn,Varout,SIZE(VarIn,1),SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4))
    ELSE
       CALL orch_scatter_unindexed_mpi_igen(dummy,Varout,1,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4))
    ENDIF

#endif
  END SUBROUTINE scatter_unindexed_mpi_i3


  SUBROUTINE scatter_unindexed_mpi_r(VarIn, VarOut)
...
#else
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_rgen(VarIn,Varout,SIZE(VarIn,1),1)
    ELSE
       CALL orch_scatter_unindexed_mpi_rgen(dummy,Varout,1,1)
    ENDIF
#endif
  END SUBROUTINE scatter_unindexed_mpi_r

  SUBROUTINE scatter_unindexed_mpi_r1(VarIn, VarOut)
...
#else
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_rgen(VarIn,Varout,SIZE(VarIn,1),SIZE(VarOut,2))
    ELSE
       CALL orch_scatter_unindexed_mpi_rgen(dummy,Varout,1,SIZE(VarOut,2))
    ENDIF

#endif
  END SUBROUTINE scatter_unindexed_mpi_r1

  SUBROUTINE scatter_unindexed_mpi_r2(VarIn, VarOut)
...
#else
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_rgen(VarIn,Varout,SIZE(VarIn,1),SIZE(VarOut,2)*SIZE(VarOut,3))
    ELSE
       CALL orch_scatter_unindexed_mpi_rgen(dummy,Varout,1,SIZE(VarOut,2)*SIZE(VarOut,3))
    ENDIF

#endif
  END SUBROUTINE scatter_unindexed_mpi_r2

  SUBROUTINE scatter_unindexed_mpi_r3(VarIn, VarOut)
...
#else
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_rgen(VarIn,Varout,SIZE(VarIn,1),SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4))
    ELSE
       CALL orch_scatter_unindexed_mpi_rgen(dummy,Varout,1,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4))
    ENDIF
#endif
  END SUBROUTINE scatter_unindexed_mpi_r3


  SUBROUTINE scatter_unindexed_mpi_l(VarIn, VarOut)
...
#else
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_lgen(VarIn,Varout,SIZE(VarIn,1),1)
    ELSE
       CALL orch_scatter_unindexed_mpi_lgen(dummy,Varout,1,1)
    ENDIF
#endif
  END SUBROUTINE scatter_unindexed_mpi_l

  SUBROUTINE scatter_unindexed_mpi_l1(VarIn, VarOut)
...
#else
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_lgen(VarIn,Varout,SIZE(VarIn,1),SIZE(VarOut,2))
    ELSE
       CALL orch_scatter_unindexed_mpi_lgen(dummy,Varout,1,SIZE(VarOut,2))
    ENDIF
#endif
  END SUBROUTINE scatter_unindexed_mpi_l1

  SUBROUTINE scatter_unindexed_mpi_l2(VarIn, VarOut)
...
#else
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_lgen(VarIn,Varout,SIZE(VarIn,1),SIZE(VarOut,2)*SIZE(VarOut,3))
    ELSE
       CALL orch_scatter_unindexed_mpi_lgen(dummy,Varout,1,SIZE(VarOut,2)*SIZE(VarOut,3))
    ENDIF
#endif
  END SUBROUTINE scatter_unindexed_mpi_l2

  SUBROUTINE scatter_unindexed_mpi_l3(VarIn, VarOut)
...
#else
    IF (is_mpi_root) THEN
       CALL orch_scatter_unindexed_mpi_lgen(VarIn,Varout,SIZE(VarIn,1),SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4))
    ELSE
       CALL orch_scatter_unindexed_mpi_lgen(dummy,Varout,1,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4))
    ENDIF
#endif
  END SUBROUTINE scatter_unindexed_mpi_l3
...
!!!!! --> Les entiers
  ...
  SUBROUTINE gather_unindexed_mpi_i(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_igen(VarIn,VarOut,SIZE(VarOut,1),1)
    ELSE
       CALL orch_gather_unindexed_mpi_igen(VarIn,dummy,1,1)
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_i

!!!!!

  SUBROUTINE gather_unindexed_mpi_i1(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_igen(VarIn,VarOut,SIZE(VarOut,1),SIZE(VarIn,2))
    ELSE
       CALL orch_gather_unindexed_mpi_igen(VarIn,dummy,1,SIZE(VarIn,2))
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_i1

!!!!!

  SUBROUTINE gather_unindexed_mpi_i2(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_igen(VarIn,VarOut,SIZE(VarOut,1),SIZE(VarIn,2)*SIZE(VarIn,3))
    ELSE
       CALL orch_gather_unindexed_mpi_igen(VarIn,dummy,1,SIZE(VarIn,2)*SIZE(VarIn,3))
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_i2

!!!!!

  SUBROUTINE gather_unindexed_mpi_i3(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_igen(VarIn,VarOut,SIZE(VarOut,1),SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4))
    ELSE
       CALL orch_gather_unindexed_mpi_igen(VarIn,dummy,1,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4))
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_i3

!!!!! --> Les reels

  SUBROUTINE gather_unindexed_mpi_r(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_rgen(VarIn,VarOut,SIZE(VarOut,1),1)
    ELSE
       CALL orch_gather_unindexed_mpi_rgen(VarIn,dummy,1,1)
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_r

!!!!!

  SUBROUTINE gather_unindexed_mpi_r1(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_rgen(VarIn,VarOut,SIZE(VarOut,1),SIZE(VarIn,2))
    ELSE
       CALL orch_gather_unindexed_mpi_rgen(VarIn,dummy,1,SIZE(VarIn,2))
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_r1

!!!!!

  SUBROUTINE gather_unindexed_mpi_r2(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_rgen(VarIn,VarOut,SIZE(VarOut,1),SIZE(VarIn,2)*SIZE(VarIn,3))
    ELSE
       CALL orch_gather_unindexed_mpi_rgen(VarIn,dummy,1,SIZE(VarIn,2)*SIZE(VarIn,3))
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_r2

!!!!!

  SUBROUTINE gather_unindexed_mpi_r3(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_rgen(VarIn,VarOut,SIZE(VarOut,1),SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4))
    ELSE
       CALL orch_gather_unindexed_mpi_rgen(VarIn,dummy,1,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4))
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_r3

!!!!! --> Les booleen

  SUBROUTINE gather_unindexed_mpi_l(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_lgen(VarIn,VarOut,SIZE(VarOut,1),1)
    ELSE
       CALL orch_gather_unindexed_mpi_lgen(VarIn,dummy,1,1)      
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_l

!!!!!

  SUBROUTINE gather_unindexed_mpi_l1(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_lgen(VarIn,VarOut,SIZE(VarOut,1),SIZE(VarIn,2))
    ELSE
       CALL orch_gather_unindexed_mpi_lgen(VarIn,dummy,1,SIZE(VarIn,2))
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_l1

!!!!!

  SUBROUTINE gather_unindexed_mpi_l2(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_lgen(VarIn,VarOut,SIZE(VarOut,1),SIZE(VarIn,2)*SIZE(VarIn,3))
    ELSE
       CALL orch_gather_unindexed_mpi_lgen(VarIn,dummy,1,SIZE(VarIn,2)*SIZE(VarIn,3))
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_l2

!!!!!

  SUBROUTINE gather_unindexed_mpi_l3(VarIn, VarOut)
    ...
    IF (is_mpi_root) THEN
       CALL orch_gather_unindexed_mpi_lgen(VarIn,VarOut,SIZE(VarOut,1),SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4))
    ELSE
       CALL orch_gather_unindexed_mpi_lgen(VarIn,dummy,1,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4))
    ENDIF

#endif
  END SUBROUTINE gather_unindexed_mpi_l3
...
SUBROUTINE orch_scatter_unindexed_mpi_igen(VarIn, VarOut, nbp, dimsize)
  USE mod_orchidee_para_var
  USE timer
  ...
  INTEGER(i_std),INTENT(IN) :: dimsize
  INTEGER(i_std),INTENT(IN),DIMENSION(nbp,dimsize) :: VarIn
  INTEGER(i_std),INTENT(OUT),DIMENSION(ij_nb,dimsize) :: VarOut

  INCLUDE 'mpif.h'

  INTEGER(i_std),DIMENSION(0:mpi_size-1) :: displs
  INTEGER(i_std),DIMENSION(0:mpi_size-1) :: counts
  INTEGER(i_std),DIMENSION(dimsize*iim_g*jjm_g) :: VarTmp
  ...
  IF (is_mpi_root) THEN
     ...
     DO rank=0,mpi_size-1
        ...
        counts(rank)=nb*dimsize
        DO i=1,dimsize
           VarTmp(Index_para:Index_para+nb-1)=VarIn(ij_para_begin(rank):ij_para_end(rank),i)
           Index_para=Index_para+nb
        ENDDO
     ENDDO
     IF (check) THEN
        WRITE(numout,*) "orch_scatter_unindexed_mpi_igen VarIn",VarIn
        WRITE(numout,*) "orch_scatter_unindexed_mpi_igen VarTmp",VarTmp
     ENDIF
  ENDIF

  CALL MPI_SCATTERV(VarTmp,counts,displs,MPI_INT_ORCH,VarOut,ij_nb*dimsize,   &
       MPI_INT_ORCH,mpi_rank_root, MPI_COMM_ORCH,ierr)
  IF (flag) CALL resume_timer(timer_mpi)
  IF (check) &
       WRITE(numout,*) "orch_scatter_unindexed_mpi_igen VarOut",VarOut

END SUBROUTINE orch_scatter_unindexed_mpi_igen

SUBROUTINE orch_scatter_unindexed_mpi_rgen(VarIn, VarOut, nbp, dimsize)
  USE mod_orchidee_para_var
  USE timer
  ...
  INTEGER(i_std),INTENT(IN) :: nbp
  REAL(r_std),INTENT(IN),DIMENSION(nbp,dimsize) :: VarIn
  REAL(r_std),INTENT(OUT),DIMENSION(ij_nb,dimsize) :: VarOut

  INCLUDE 'mpif.h'

  INTEGER(i_std),DIMENSION(0:mpi_size-1) :: displs
  INTEGER(i_std),DIMENSION(0:mpi_size-1) :: counts
  REAL(r_std),DIMENSION(dimsize*iim_g*jjm_g) :: VarTmp
  ...
  IF (is_mpi_root) THEN
     ...
     ENDDO
     IF (check) THEN
        WRITE(numout,*) "orch_scatter_unindexed_mpi_rgen VarIn",VarIn
        WRITE(numout,*) "orch_scatter_unindexed_mpi_rgen VarTmp",VarTmp
     ENDIF
  ENDIF

  CALL MPI_SCATTERV(VarTmp,counts,displs,MPI_REAL_ORCH,VarOut,ij_nb*dimsize,   &
       MPI_REAL_ORCH,mpi_rank_root, MPI_COMM_ORCH,ierr)

  IF (flag) CALL resume_timer(timer_mpi)
  IF (check) &
       WRITE(numout,*) "orch_scatter_unindexed_mpi_rgen VarOut",VarOut

END SUBROUTINE orch_scatter_unindexed_mpi_rgen

SUBROUTINE orch_scatter_unindexed_mpi_lgen(VarIn, VarOut, nbp, dimsize)
  USE mod_orchidee_para_var
  USE timer
  ...
  INTEGER(i_std),INTENT(IN) :: nbp
  LOGICAL,INTENT(IN),DIMENSION(nbp,dimsize) :: VarIn
  LOGICAL,INTENT(OUT),DIMENSION(ij_nb,dimsize) :: VarOut

  INCLUDE 'mpif.h'

  INTEGER(i_std),DIMENSION(0:mpi_size-1) :: displs
  INTEGER(i_std),DIMENSION(0:mpi_size-1) :: counts
  LOGICAL,DIMENSION(dimsize*iim_g*jjm_g) :: VarTmp
  ...
  IF (is_mpi_root) THEN
     ...
     ENDDO
     IF (check) THEN
        WRITE(numout,*) "orch_scatter_unindexed_mpi_lgen VarIn",VarIn
        WRITE(numout,*) "orch_scatter_unindexed_mpi_lgen VarTmp",VarTmp
     ENDIF
  ENDIF

  CALL MPI_SCATTERV(VarTmp,counts,displs,MPI_LOGICAL,VarOut,ij_nb*dimsize,   &
       MPI_LOGICAL,mpi_rank_root, MPI_COMM_ORCH,ierr)
  IF (flag) CALL resume_timer(timer_mpi)
  IF (check) &
       WRITE(numout,*) "orch_scatter_unindexed_mpi_lgen VarOut",VarOut

END SUBROUTINE orch_scatter_unindexed_mpi_lgen


SUBROUTINE orch_gather_unindexed_mpi_igen(VarIn, VarOut, nbp, dimsize)
  USE mod_orchidee_para_var
  USE timer
  ...
  INTEGER(i_std),INTENT(IN) :: dimsize
  INTEGER(i_std),INTENT(IN) :: nbp
  INTEGER(i_std),INTENT(IN),DIMENSION(ij_nb,dimsize) :: VarIn
  INTEGER(i_std),INTENT(OUT),DIMENSION(nbp,dimsize) :: VarOut
  ...
  IF (is_mpi_root) THEN
	...
	Index_para=Index_para+nb*dimsize
     ENDDO
     IF (check) &
          WRITE(numout,*) "orch_gather_unindexed_mpi_igen ij_para_nb, displs, counts,Index_Para-1",&
          ij_para_nb, displs, counts,Index_Para-1

  ENDIF

  CALL MPI_GATHERV(VarIn,ij_nb*dimsize,MPI_INT_ORCH,VarTmp,counts,displs,   &
       MPI_INT_ORCH,mpi_rank_root, MPI_COMM_ORCH,ierr)
  ...
  IF (is_mpi_root) THEN
     ...
     DO rank=0,mpi_size-1
        nb=ij_para_nb(rank)
        DO i=1,dimsize
           VarOut(ij_para_begin(rank):ij_para_end(rank),i)=VarTmp(Index_para:Index_para+nb-1)
           Index_para=Index_para+nb
        ENDDO
     ENDDO
  ENDIF
  IF (check) &
       WRITE(numout,*) "orch_gather_unindexed_mpi_igen VarOut=",VarOut
  IF (flag) CALL resume_timer(timer_mpi)

END SUBROUTINE orch_gather_unindexed_mpi_igen


SUBROUTINE orch_gather_unindexed_mpi_rgen(VarIn, VarOut, nbp, dimsize)
  USE mod_orchidee_para_var
  USE timer
  ...
  INTEGER(i_std),INTENT(IN) :: dimsize
  INTEGER(i_std),INTENT(IN) :: nbp
  REAL(r_std),INTENT(IN),DIMENSION(ij_nb,dimsize) :: VarIn
  REAL(r_std),INTENT(OUT),DIMENSION(nbp,dimsize) :: VarOut
  ...
  IF (is_mpi_root) THEN
	...
	Index_para=Index_para+nb*dimsize
     ENDDO
     IF (check) &
          WRITE(numout,*) "orch_gather_unindexed_mpi_rgen ij_para_nb, displs, counts,Index_Para-1",&
          ij_para_nb, displs, counts,Index_Para-1

  ENDIF

  IF (check) &
       WRITE(numout,*) "orch_gather_unindexed_mpi_rgen VarIn=",VarIn    
  CALL MPI_GATHERV(VarIn,ij_nb*dimsize,MPI_REAL_ORCH,VarTmp,counts,displs,   &
       MPI_REAL_ORCH,mpi_rank_root, MPI_COMM_ORCH,ierr)
  IF (check) &
       WRITE(numout,*) "orch_gather_unindexed_mpi_rgen dimsize,VarTmp=",dimsize,VarTmp
  ...
  ENDIF
  IF (check) &
       WRITE(numout,*) "orch_gather_unindexed_mpi_rgen VarOut=",VarOut
  IF (flag) CALL resume_timer(timer_mpi)

END SUBROUTINE orch_gather_unindexed_mpi_rgen

SUBROUTINE orch_gather_unindexed_mpi_lgen(VarIn, VarOut, nbp, dimsize)
  USE mod_orchidee_para_var
  USE timer
  ...
  INTEGER(i_std),INTENT(IN) :: dimsize
  INTEGER(i_std),INTENT(IN) :: nbp
  LOGICAL,INTENT(IN),DIMENSION(ij_nb,dimsize) :: VarIn
  LOGICAL,INTENT(OUT),DIMENSION(nbp,dimsize) :: VarOut
  ...
  IF (is_mpi_root) THEN
	...
	Index_para=Index_para+nb*dimsize
     ENDDO
     IF (check) &
          WRITE(numout,*) "orch_gather_unindexed_mpi_lgen ij_para_nb, displs, counts,Index_Para-1",&
          ij_para_nb, displs, counts,Index_Para-1
  ENDIF

  IF (check) &
       WRITE(numout,*) "orch_gather_unindexed_mpi_lgen VarIn=",VarIn    
  CALL MPI_GATHERV(VarIn,ij_nb*dimsize,MPI_LOGICAL,VarTmp,counts,displs,   &
       MPI_LOGICAL,mpi_rank_root, MPI_COMM_ORCH,ierr)
  IF (check) &
       WRITE(numout,*) "orch_gather_unindexed_mpi_lgen dimsize,VarTmp=",dimsize,VarTmp
  ...
  ENDIF
  IF (check) &
       WRITE(numout,*) "orch_gather_unindexed_mpi_lgen VarOut=",VarOut
  IF (flag) CALL resume_timer(timer_mpi)

END SUBROUTINE orch_gather_unindexed_mpi_lgen
